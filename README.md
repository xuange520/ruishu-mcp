...
- Chrome 浏览器 (需启用调试端口运行 / Requires running with remote debugging port)

### 编译步骤 / Build Steps

```bash
# 1. 克隆代码库 / Clone the repository
git clone https://github.com/your-username/ruishu-mcp-cdp.git
cd ruishu-mcp-cdp
...
```json
{
  "mcpServers": {
    "ruishu-cdp": {
      "command": "node",
      "args": ["/absolute/path/to/ruishu-mcp-cdp/dist/index.js"]
    }
  }
}
```

### 第三步：AI 自动调用 / AI Agent Invocation
